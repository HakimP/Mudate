...
class CaracteristicasControllerTest < ActionController::TestCase
  ...
  test "should create caracteristica" do
    assert_difference('Caracteristica.count') do
      post :create, caracteristica: { costo: @caracteristica.costo, descripcion: @caracteristica.descripcion, estatus: @caracteristica.estatus, servicio_id: @caracteristica.servicio_id }
    end
  ...
  test "should update caracteristica" do
    patch :update, id: @caracteristica, caracteristica: { costo: @caracteristica.costo, descripcion: @caracteristica.descripcion, estatus: @caracteristica.estatus, servicio_id: @caracteristica.servicio_id }
    assert_redirected_to caracteristica_path(assigns(:caracteristica))
  end

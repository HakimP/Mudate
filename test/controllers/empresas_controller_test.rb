...
class EmpresasControllerTest < ActionController::TestCase
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post :create, empresa: { estatus: @empresa.estatus, nombre: @empresa.nombre, razon_social: @empresa.razon_social }
    end
  ...
  test "should update empresa" do
    patch :update, id: @empresa, empresa: { estatus: @empresa.estatus, nombre: @empresa.nombre, razon_social: @empresa.razon_social }
    assert_redirected_to empresa_path(assigns(:empresa))
  end
